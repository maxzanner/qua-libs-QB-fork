...
port = None  # QOP Port
cluster_name = "MQC_Cluster"  # Name of the cluster
...
########################################################################################################################
qubits = [1, 2, 3, 4]
# qubit_pairs = [(qubits[i], qubits[i + 1]) for i in range(len(qubits) - 1)] # Uncomment this line if you want to use pairs of qubits (need a ways to define connectivity)
