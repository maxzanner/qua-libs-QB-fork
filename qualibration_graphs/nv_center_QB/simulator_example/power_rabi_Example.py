...
a_vec = np.arange(0.02, 1, 0.02)  # The amplitude pre-factor vector
...
#######################
    ...
    # if simulate:
    job = qmm.simulate(config, power_rabi, SimulationConfig(20_000))
    fetched_data = False
    ...
    # else:
    #     print('Only simulation is implemented in this example. Please set "simulate" to True to run the simulation.')
