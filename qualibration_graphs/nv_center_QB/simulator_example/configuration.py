...
# Network parameters #
######################
qop_ip = "127.0.0.0"  # Write the OPX IP address
cluster_name = "cluster_name"  # Write your cluster_name if version >= QOP220
...
lf_fem = 2  # This should be the index of the LF-FEM module, e.g., 2
                ...
                lf_fem: {
                    ...
                    "analog_outputs": {
                        ...
                        1: {
                            ...
                            # NOTE: duration parameterization of arb. waveforms, time tagging, sticky elements and chirping
